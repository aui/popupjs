...
artDialog.create = function (options) {
	...
	var $popup = this._popup = $(this.node);
...
$.extend(prototype, {
	...
	_trigger: function (id) {
		...
		if (/^(ok|cancel)$/.test(id)) {
			id = 'button:' + this.id + '-' + id;
		}
